...
function updateHelp(word) {
    ...
    var word2def;
    var translationUrl = "https://translation.googleapis.com/language/translate/v2?key=AIzaSyC4yj2gSTHnyoSKVd90yik-ryZZMA_5z3E&source=fr&target=en&q=" + helpWord;
    ...
    $.get(translationUrl, function(data) {
        ...
        $.ajax({
            ...
            defHelpBox = document.getElementById("def");
            if (!defHelpBox) {
            ...
            if (helpWord.length > 3) {
                ...
                $.get(gifURL, function(data){
                    ...
                    gifHelpBox = document.getElementById('gif');
                    if (!gifHelpBox) {
